...
public class LolipopBullet extends Bullet {
    ...
    public LolipopBullet(double x, double y, double velocityX, double velocityY, 
    Room presentRoom) {
        super(x,y, velocityX, velocityY, 4, 0, 0, 5, 
         21, 21, 0, 0, 0, true, 
        presentRoom, new Ellipse2D.Double((int) (x - 10.5),(int) (y - 10.5), 21, 21), 
        "Lolipop_Bullet.png",
        1, 0, "LoliPop");
    }
